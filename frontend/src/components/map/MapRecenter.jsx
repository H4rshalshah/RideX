...
const MapRecenter = ({ target = null, zoom = 15 }) => {
  ...
  return (
    <button
      ...
      className="ridex-recenter absolute bottom-3 right-3 z-[1000] flex h-9 w-9 items-center justify-center rounded-full border border-ui-line bg-ui-card/90 text-ui-ink shadow-card backdrop-blur-sm transition hover:bg-ui-card2 active:scale-95"
    >
